 ...
 * 10/30/2006               Motorola      Fixed a type-casting bug with ipt_get_target()
 *                                        function and enclosed the changes inside
 *                                        CONFIG_MOT_WFN440 ifdef.
 */
